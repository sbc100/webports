...
#ifndef EXAMPLES_SCRIPTABLE_CRYPTO_SCRIPTING_BRIDGE_H_
#define EXAMPLES_SCRIPTABLE_CRYPTO_SCRIPTING_BRIDGE_H_
...
#endif  // EXAMPLES_SCRIPTABLE_CRYPTO_SCRIPTING_BRIDGE_H_
