...
This example demonstrates how to create three versions of a simple 2D
graphics application:
- using Pepper in C
- using Pepper in C++
- using SDL from naclports
This example is based on the test in the Google Native Client project
(http://code.google.com/p/nativeclient) under tests/earth.
