...
void skip_input_data(j_decompress_ptr cinfo, int32_t num_bytes) {
   ...
   */
  if (num_bytes > 0) {
    while (num_bytes > (int32_t) src->bytes_in_buffer) {
      num_bytes -= (int32_t) src->bytes_in_buffer;
