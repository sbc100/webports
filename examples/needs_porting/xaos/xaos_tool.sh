...
readonly URL_XAOS=http://storage.googleapis.com/nativeclient-mirror/nacl/XaoS-3.4.tar.gz
readonly URL_GSL=http://storage.googleapis.com/nativeclient-mirror/nacl/gsl-1.9.tar.gz
