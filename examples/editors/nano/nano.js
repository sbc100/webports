...
/**
 * The Nano-powered terminal command.
 *
...
/**
 * Static initialier called from nano.html.
 *
 * This constructs a new Terminal instance and instructs it to run the Nano
 * command.
 */
Nano.init = function() {
  ...
  terminal.runCommandClass(Nano, document.location.hash.substr(1));
 ...
 * @private
 */
Nano.prototype.handleMessage_ = function(e) {
  if (e.data.indexOf(Nano.prefix_) != 0) return;
  var msg = e.data.substring(Nano.prefix_.length);
  term_.io.print(msg);
}
 ...
 */
Nano.prototype.handleLoadEnd_ = function(e) {
 ...
 */
Nano.prototype.handleProgress_ = function(e) {
 ...
 */
Nano.prototype.handleCrash_ = function(e) {
