...
/**
 * The Sqlite-powered terminal command.
 *
 * This class defines a command that can be run in an hterm.Terminal instance.
 *
 * @param {Object} argv The argument object passed in from the Terminal.
 */
function Sqlite(argv) {
  this.argv_ = argv;
  this.io = null;
};
 ...
 * @private
 */
Sqlite.prefix_ = 'tty_io:';

/**
 * Static initialier called from index.html.
 *
 * This constructs a new Terminal instance and instructs it to run the Sqlite
 * command.
 */
Sqlite.init = function() {
  ...
  terminal.runCommandClass(Sqlite, document.location.hash.substr(1));
 ...
 * @private
 */
Sqlite.prototype.handleMessage_ = function(e) {
  if (e.data.indexOf(Sqlite.prefix_) != 0) return;
  var msg = e.data.substring(Sqlite.prefix_.length);
  term_.io.print(msg);
}
 ...
 */
Sqlite.prototype.handleLoadEnd_ = function(e) {
 ...
 */
Sqlite.prototype.handleProgress_ = function(e) {
 ...
 */
Sqlite.prototype.handleCrash_ = function(e) {
