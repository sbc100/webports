 ...
 */
#ifndef PACKAGES_SCRIPTS_NACL_MOUNTS_CONSOLE_JSPOSTMESSAGEBRIDGE_H_
#define PACKAGES_SCRIPTS_NACL_MOUNTS_CONSOLE_JSPOSTMESSAGEBRIDGE_H_
...
#endif  // PACKAGES_SCRIPTS_NACL_MOUNTS_CONSOLE_JSPOSTMESSAGEBRIDGE_H_
