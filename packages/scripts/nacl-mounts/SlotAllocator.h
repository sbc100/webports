 ...
 */
#ifndef PACKAGES_SCRIPTS_NACL_MOUNTS_SLOTALLOCATOR_H_
#define PACKAGES_SCRIPTS_NACL_MOUNTS_SLOTALLOCATOR_H_
...
#endif  // PACKAGES_SCRIPTS_NACL_MOUNTS_SLOTALLOCATOR_H_
