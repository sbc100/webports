...
console.Console.prototype.got = function(str) {
  ...
  // Ignore if module isn't ready.
  if (!this.naclModule_.__moduleReady) return;
  // Send to nacl module.
  var stre = escape_string(str);
  var out = unescape_string(this.naclModule_.console(stre));
  this.write(out);
};
...
/**
 * Takeover keyboard focus.
 */ 
console.Console.prototype.focus = function() {
  var focus_this = this;;
