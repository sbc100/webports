 ...
 */
DebugConnection_.prototype.setDebugPort_ = function(debugTcpPort) {
...
DebugConnection_.prototype.handleMessage_ = function(msg) {
  ...
  } else if (msg.name == 'setDebugPort') {
    self.setDebugPort_(msg.port);
...
chrome.runtime.onConnectExternal.addListener(function(port) {
  ...
  if (navigator.userAgent != 'ChromeTestAgent') {
