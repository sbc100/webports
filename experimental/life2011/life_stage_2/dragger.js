 ...
 * events, and when it sees one, starts capturing mousemove events until it
 * gets a mousup event.  It manufactures three kinds of drag events:
 ...
 * that @a listener does not already exist in the array of listeners.
...
uikit.Dragger.prototype.onMouseDown = function(event) {
  ...
  // relative to the top-left of the target which gets @a event.  The clientX/Y
...
/**
 * Bind a scope to a function.  Used to bind an object to @a this for event
 * handlers.
 * @param {!Object} scope The scope in which the function executes.  @a scope
 *     becomes @a this during function execution.
